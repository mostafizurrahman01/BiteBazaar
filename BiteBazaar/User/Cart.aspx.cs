...
//            //            {
//            //                updatedQuantity = quantityFromDB;
//            //                isTrue = true;
//            //            }
...
//            public bool UpdateCartQuantity(int productId, int quantity)
//            {
//                int userId = Convert.ToInt32(HttpContext.Current.Session["userId"]);
//                return Utils.UpdateCartQuantity(quantity, productId, userId);
//            }
...
namespace BiteBazaar.User
{
    public partial class Cart : System.Web.UI.Page
    {
        ...
        public static bool UpdateCartQuantity(int productId, int quantity)
        {
            int userId = Convert.ToInt32(HttpContext.Current.Session["userId"]);
            return Utils.UpdateCartQuantity(quantity, productId, userId);
        }
