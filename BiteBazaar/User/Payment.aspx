<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="BiteBazaar.User.Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="book_section" style="background-image: url('../Images/No_image.jpg'); width: 100%; height: 100%; background-repeat: no-repeat; 
            ...
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" Display="Dynamic"
                                                        ErrorMessage="CVV no. must be of 4 digits" ForeColor="Red" SetFocusOnError="true"
                                                        ValidationExpression="[0-9]{4}" ControlToValidate="txtCvv" ValidationGroup="card">*
                                                    </asp:RegularExpressionValidator>
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm">Order Total: TK <% Response.Write(Session["grandTotalPrice"]); %> </b>
                            <div class="pt-1">
